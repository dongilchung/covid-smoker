...
% Figure S4B: Regression;
% DV = Beliefs about the risk of infection
% IV = Beliefs about the risk of second-hand smoking
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
IV = [Sample1_demo_Sex zscore(Sample1_demo_Education) zscore(Sample1_demo_PoliticalOrientation),...
    zscore(Sample1_smoking_perceivedRiskOfSecondHandSmoking).*Sample1_smoking_StatusS, ...
    zscore(Sample1_smoking_perceivedRiskOfSecondHandSmoking).*Sample1_smoking_StatusPS, ...
    zscore(Sample1_smoking_perceivedRiskOfSecondHandSmoking).*Sample1_smoking_StatusNS];
...
IV = [Sample2_demo_Sex zscore(Sample2_demo_Education) zscore(Sample2_demo_PoliticalOrientation),...
    zscore(Sample2_smoking_perceivedRiskOfSecondHandSmoking).*Sample2_smoking_StatusS, ...
    zscore(Sample2_smoking_perceivedRiskOfSecondHandSmoking).*Sample2_smoking_StatusPS, ...
    zscore(Sample2_smoking_perceivedRiskOfSecondHandSmoking).*Sample2_smoking_StatusNS];
IV_names = {'gender','education','political','S*direct','PS*direct', 'NS*direct'};
