%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure S7 % Jiwon Park % 2023/09/21
% Regression; DV = Preventive Motives / Group difference
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DV = zscore(Sample1_covid_PreventiveMotives_others);
...
DV = zscore(Sample2_covid_PreventiveMotives_others);
...
stats=regstats(DV, IV);
dataB2=[0:length(stats.tstat.beta')-1 ; stats.tstat.beta'; stats.tstat.pval']
Beta=(stats.tstat.beta);
BetaSE=(stats.tstat.se);
BetaP=(stats.tstat.pval);
delta=0.1;
