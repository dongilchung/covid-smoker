%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure S3 % Jiwon Park % 2023/09/21
% Figure S3B: Regression; DV = Beliefs about the risk fo second-hand smoking
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% regression datat
DV = zscore(Sample1_smoking_perceivedRiskOfSecondHandSmoking);
IV = [Sample1_demo_Sex zscore(Sample1_demo_Education) zscore(Sample1_demo_PoliticalOrientation),...
    Sample1_smoking_StatusS, Sample1_smoking_StatusPS];
IV_names = {'gender','education','political','S','PS'};
...
% regression datat
DV = zscore(Sample2_smoking_perceivedRiskOfSecondHandSmoking);
IV = [Sample2_demo_Sex zscore(Sample2_demo_Education) zscore(Sample2_demo_PoliticalOrientation),...
    Sample2_smoking_StatusS, Sample2_smoking_StatusPS];
IV_names = {'gender','education','political','S','PS'};
...
xticks(1:length(IV_names))
xticklabels(IV_names)
ylabel('Standardized beta');


xlim([0 6])
yticks(0-0.3:0.3:0.6)
ylim([-0.7 0.3])
