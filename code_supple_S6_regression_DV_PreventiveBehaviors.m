%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure S6 % Jiwon Park % 2023/09/21
% Regression; DV = Preventive behaviors / Group difference
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
DV = zscore(Sample1_covid_PreventiveBehaviors);
...
DV = zscore(Sample2_covid_PreventiveBehaviors);
