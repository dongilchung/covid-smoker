...
% Figure S3A: Regression; DV = Beliefs about the risk of direct smoking
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% regression datat
DV = zscore(Sample1_smoking_perceivedRiskOfDirectSmoking);
...
% regression datat
DV = zscore(Sample2_smoking_perceivedRiskOfDirectSmoking);
